...
export const PageLayoutContent = ({ assistant = null }: { assistant?: ReactNode }) => {
  ...
  return (
    <div className="flex min-h-screen text-slate-900 dark:text-slate-100 font-sans">
      ...
      <div className="relative flex min-w-0 flex-1 flex-col md:ml-sidebar">
        <div className="fixed pointer-events-none overflow-hidden inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-glow h-glow bg-violet-500/5 dark:bg-violet-600/5 rounded-full blur-3xl" />
        </div>
        ...
        <main id="main-content" tabIndex={-1} className="relative z-10 flex-1 p-4 md:p-6 overflow-y-auto max-w-content w-full mx-auto focus:outline-none">

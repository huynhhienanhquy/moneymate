    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
      <div className="app-shell-card w-full max-w-md p-6 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            <AppLabel htmlFor="wallet-balance" className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5">{wallet ? 'Số dư hiện tại' : 'Số dư ban đầu'}</AppLabel>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <AppButton unstyled id="wallet-save" onClick={() => onSave(wallet ? { name: form.name, type: form.type, initialBalance: form.initialBalance } : form)} disabled={loading || !form.name} className="app-primary-button flex-1">

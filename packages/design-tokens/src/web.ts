...
export const webTheme = {
  ...
  maxWidth: { content: '1180px', admin: '1280px', auth: '440px', 'auth-copy': '290px', 'chat-message': '85%', 'chat-viewport': 'calc(100vw - 2rem)' },
  width: {
    'admin-member': '22%', 'admin-email': '28%', 'admin-role': '10%', 'admin-transactions': '10%', 'admin-wallets': '7%', 'admin-date': '14%', 'admin-actions': '9%',
  ...
  minWidth: { counter: '25px', 'table-compact': '500px', table: '760px', 'admin-table': '1000px' },
